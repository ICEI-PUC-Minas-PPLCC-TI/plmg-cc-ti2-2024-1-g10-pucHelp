...
public class UsuarioService {
    ...
    public Object add(Request request, Response response) {
        ...
        String email = request.queryParams("email"); // Adicionar e-mail

        int id = usuarioDao.getMaxId() + 1;

        Usuario usuario = new Usuario(cpf, nome, senha, matricula, tipo, idCurso, periodo, email); // Modificar construtor
    ...
    public Object getUsuarioById(Request request, Response response) {
        try {
            ...
            if (usuario != null) {
                ...
                jsonResponse.put("email", usuario.getEmail()); // Adicionar o campo de e-mail
    ...
    public String login(Request request, Response response) {
        ...
        try {
            ...
            if (user.getSenha().equals(senha)) {
                ...
                jsonObject.put("email", user.getEmail()); // Adicionar o campo de e-mail
